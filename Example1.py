...
# -*- coding: utf-8 -*-
"""
Example 2: Nonlinear Volterra dynamic integral equation on time scale
T = {0,1,2,4,8,16,32}
Equation: x(t) = 1 + (1/5000) ∫_0^t (t - 2s) x(s) Δs
Exact solution computed recursively.
Neural residual solver: trains a neural network to minimize residual of discrete fixed‑point problem.
"""
...
# ------------------------------------------------------------
# Exact solution using the corrected recursion
# ------------------------------------------------------------
